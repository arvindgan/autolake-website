...
export default function IndustriesAuth() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (password === "blob") {
      ...
      sessionStorage.setItem("industriesAuthenticated", "true")
      // Redirect to the actual industries page
        ...
        <main className="container py-24 flex flex-col items-center justify-center">
          ...
          >
            ...
            <p className="text-muted-foreground text-center mb-8">
              Please enter the password to access the Industries page.
            </p>
