...
export default function WorksOnAllPlatforms() {
  return (
    <AnimatedSection className="relative py-24 md:py-32 overflow-hidden bg-[#fdfaf5] text-gray-900">
      ...
      <div className="container mx-auto flex flex-col items-center gap-12">
        ...
        <div className="mx-auto max-w-4xl text-center">
          <p className="uppercase text-sm tracking-wide text-muted-foreground mb-2">
        ...
        <div className="flex flex-wrap justify-center gap-6 sm:gap-10 mt-8">
          {[
            ...
            <div
              key={logo.alt}
              className="relative h-28 w-44 sm:h-36 sm:w-56 rounded-2xl bg-gray-100 border border-gray-300 shadow-lg hover:bg-gray-200 transition-colors flex items-center justify-center"
            >
