    ...
    <footer className="bg-blue-900 text-white py-12">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          ...
          <p className="text-blue-200">Streamlining your data lake, one workflow at a time.</p>
        </div>
        <div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <Link href="/about-us" className="text-blue-200 hover:text-white">
                About Us
              </Link>
            </li>
            <li>
      ...
      <div className="container mx-auto mt-8 pt-8 border-t border-blue-800 text-center text-blue-200">
