...
const connectors: Connector[] = [
  ...
  { name: "Azure Cosmos", logo: "☁️", category: "Database", imageUrl: "/images/connectors/icon-azurecosmos.webp" },
  ...
  { name: "Blackbaud", logo: "💼", category: "CRM", imageUrl: "/images/connectors/icon-blackbaud.webp" },
  ...
  { name: "Docusign Monitor", logo: "📋", category: "Document", imageUrl: "/images/connectors/icon-docusignmonitor.webp" },
